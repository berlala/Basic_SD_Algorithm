...
cur_path = cd;
addpath([cur_path,'\way_points_samples'])
 %% Config
...
x_init    = 0;
y_init    = -1.5; %
psi_init  = pi/10; % This ability rely on the max steering gain in [LQRfcn_bl] -[Limit_sample]
...
psi_c = psi_c + v /(Lf)*tan(delta_f) * Ts;
...
legend('Heading','Steering Cmd','target index')
