function [index,dis_nearest,X_clst] = find_closest(RouteMapArray,X_state)
% Update 2019/06/12
% added the dis_nearest logic
% add NaN logic
% update 
% Meituan, zhaobolin@meituan.com
%%
xp = X_state(1);
yp = X_state(2);
...
height = [0,0]; psi_d = [0,0]; xa = [0,0]; ya = [0,0]; % necessary initilization for Simulink
for n =1:1:2
